...
举例一
以下代码来自github,[点击这里](https://github.com/lkp7321/sour/blob/06ac40e140bad1dc1e7b3590ce099bc02ae065f2/fxadmin/src/main/java/com/ylxx/fx/service/po/jsh/Trd_tranlist.java)
```java
package com.ylxx.fx.service.po.jsh;

public class Trd_tranlist {
	private String lcno;
	private String trdt;
	private String trtm;
	private String trcd;
	...
	public String getCycy() {
		return cycy;
	}
	public void setCycy(String cycy) {
		this.cycy = cycy;
	}
